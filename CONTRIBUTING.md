...
The `Baaijte.Optimizely.ImageSharp.Web` repo uses Git as its source control system. If you haven't already installed it, you can download it [here](https://git-scm.com/downloads) or if you prefer a GUI-based approach, try [GitHub Desktop](https://desktop.github.com/).
...
Now that your machine is setup, you can clone the repository. Open a terminal and run this command:

```shell
git clone https://github.com/vnbaaij/Baaijte.Optimizely.ImageSharp.Web.git
```
Cloning via SSH:

```shell
git clone git@github.com:vnbaaij/Baaijte.Optimizely.ImageSharp.Web.git
```
